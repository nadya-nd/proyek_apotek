                    ...
                    <ul class="menu">
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="">Mutasi Member</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="">Informasi Member</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="extra-component-sweetalert.html">Rekap Pembelian</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="layout-default.html">Informasi Pegawai</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="layout-vertical-1-column.html">Buat Template Chat</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="layout-vertical-navbar.html">Ubah Template Chat</a>
                                </li>
                            </ul>
                        </li>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2023 &copy; ApotekAI</p>
                    </div>
                    <div class="float-end">
                        <p>Crafted with <span class="text-danger"><i class="bi bi-heart"></i></span> by <a
                                href="">D4 Teknik Informatika</a></p>
                    </div>
                </div>
            </footer>
        </div>
